...
class TradeOffer(models.Model):
    ...
    offering = models.ForeignKey(Javagochi.nickname, on_delete=models.CASCADE, blank=False)
    interested_into = models.ForeignKey(JavagochiBase.race, on_delete=models.CASCADE, blank=False)
